# -*- coding: utf-8 -*-
"""
q3 3D 吨氨成本分布图 — 方柱1:1 + 柱间距=柱宽 + 高视角
"""
...
ax.set_title('Q3 连续制氨调节 吨氨成本三维分布\n24场景 × 5产量 = 120 LP 求解',
...
ax.text2D(0.01, 0.97, info, transform=ax.transAxes, fontsize=10,
          bbox=dict(boxstyle='round,pad=0.4', facecolor='#3d0c02',
                    edgecolor='#8b0000', alpha=0.85), color='white')

png = os.path.join(SCRIPT_DIR, 'q3_3d_cost.png')
